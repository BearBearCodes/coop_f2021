...
def reg_bin_sn(signal, noise, block_size=(4, 4), print_info=True, func=np.nansum):
    """
...
def bin_sn_arrs_to_target(
    ...
    NOTE: target_wcs should support the CDELT keyword.
    TODO: add support for CD[#]_[#] keywords. I think it may already be supported?
